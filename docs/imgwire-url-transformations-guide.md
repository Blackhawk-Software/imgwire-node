...
```text
https://cdn.imgwire.dev/org/env/image?width=800&height=600&resizing_type=cover&format=webp&q=auto&progressive=auto&chroma_subsampling=4:2:2
```
...
| `chroma_subsampling`  | `chroma_subsampling`                            | `4:4:4`, `4:2:2`, `auto`                                                                                                                                      | string                                                    |
...
| `watermark_url`       | `wmu`, `watermark_url`                          | base64-encoded public HTTPS URL                                                                                                                               | string                                                    |
...
Automatic quality and JPEG encoder controls:

```text
?width=1200&format=jpg&q=auto&progressive=auto&chroma_subsampling=4:2:2
```
